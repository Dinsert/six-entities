...
import com.example.six_entities.model.ErrorResponseDTO;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponseDTO> handleObjectNotFound(ObjectNotFoundException e, HttpServletRequest request) {
